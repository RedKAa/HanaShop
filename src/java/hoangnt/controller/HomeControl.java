...
public class HomeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Product> products = productService.getAll(beginIndex, endIndex, false);
            ...
            //Paging
            int countResult = productService.countAll(isAdmin);
            ...
            request.getSession().getServletContext().setAttribute("Category", category);
